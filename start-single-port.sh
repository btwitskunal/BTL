...
# BTL Marketing Portal - Single Port Startup Script
echo "🚀 Starting BTL Marketing Portal on Single Port..."
...
if [ $? -eq 0 ]; then
    ...
    echo "❌ MySQL connection failed. Please ensure MySQL is running."
    exit 1
fi
...
echo "🎉 All checks passed! Starting single-port server..."
